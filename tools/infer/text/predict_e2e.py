...
Example:
    $ python tools/infer/text/predict_e2e.py --image_dir {path_to_img}
"""
import json
import logging
import os
...
def predict_e2e(img_path, layout_analyzer, text_system, table_analyzer, do_visualize, save_folder, recovery):
    """
    ...
    if layout_analyzer is not None:
        results = layout_analyzer(image, do_visualize=do_visualize)
    else:
