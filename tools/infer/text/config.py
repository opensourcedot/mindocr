...
def create_parser():
    ...
    parser.add_argument(
        "--table_model_dir",
        type=str,
        help="directory containing the table structure recognition model checkpoint best.ckpt, or path to a specific checkpoint file.",
    )
    parser.add_argument(
        "--table_amp_level",
        type=str,
    ...
    parser.add_argument(
        ...
        help="path to character dictionary for table structure recognition. If None, will pick according to table_algorithm and table_model_dir.",
    )
    parser.add_argument(
        "--table_max_len",
        type=int,
        default=480,
        help="max length of the input image for table structure recognition"
    )
